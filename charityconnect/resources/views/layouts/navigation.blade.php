<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('charities.index')" :active="request()->routeIs('charities.*')">
                        {{ __('Charities') }}
                    </x-nav-link>
                    ...
                    <!-- Charity Navigation Links -->
                    @if (Auth::check() && Auth::user()->isCharity())
                        <x-nav-link :href="route('charity.dashboard')" :active="request()->routeIs('charity.*')">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('charities.index')" :active="request()->routeIs('charities.*')">
                {{ __('Charities') }}
            </x-responsive-nav-link>
            ...
            <!-- Charity Navigation Links -->
            @if (Auth::check() && Auth::user()->isCharity())
                <x-responsive-nav-link :href="route('charity.dashboard')" :active="request()->routeIs('charity.*')">
                    {{ __('Charity Dashboard') }}
                </x-responsive-nav-link>
